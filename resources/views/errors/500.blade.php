...
<head>
    ...
    <title>Server Error (500) - LibSchool</title>
...
<body class="min-h-screen flex items-center justify-center p-6 antialiased bg-[#eef1fa]">
    ...
    <div class="max-w-[850px] w-full bg-white rounded-2xl shadow-[0_24px_64px_-12px_rgba(0,0,0,0.08)] p-12 md:p-24 text-center transition-all">
        ...
        <p class="text-[#4a4a4a] text-base md:text-[1.15rem] max-w-[42rem] mx-auto leading-relaxed font-semibold">
            Yah, servernya lagi ngambek...<br><br>
            Sabar ya, tim ninja kami lagi bujukin servernya biar mau jalan lagi.<br>
            Coba refresh atau balik lagi beberapa menit lagi ya.
        </p>
