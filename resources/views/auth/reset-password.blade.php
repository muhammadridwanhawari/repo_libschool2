...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex flex-col items-center px-4 pt-10 pb-4">
        <div class="w-full max-w-[420px] bg-white rounded-[1.25rem] border border-violet-100 shadow-[0_4px_24px_rgba(99,102,241,0.08)] px-9 py-9">
            ...
            {{-- Judul --}}
            <h1 class="text-[1.65rem] font-bold text-indigo-950 mb-1.5">Reset Kata Sandi</h1>
            ...
            <form method="POST" action="{{ route('password.store') }}" autocomplete="off">
                ...
                {{-- Kata Sandi Baru --}}
                <div class="mb-5">
                    <label for="password" class="block text-[0.875rem] font-semibold text-indigo-950 mb-1.5">Kata Sandi Baru</label>
                    <div class="relative">
                ...
                <div class="mb-5">
                    <label for="password_confirmation" class="block text-[0.875rem] font-semibold text-indigo-950 mb-1.5">Konfirmasi Kata Sandi</label>
                    <div class="relative">
